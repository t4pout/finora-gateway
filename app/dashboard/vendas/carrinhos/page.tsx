                    ...
                    <tr key={c.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4">
                        {c.status === 'ABANDONADO' && c.compradorTel && (
                            ...
                            href={'https://wa.me/55' + c.compradorTel.replace(/\D/g, '') + '?text=' + encodeURIComponent('Olá ' + c.compradorNome + '! Vi que você estava interessado em ' + c.produtoNome + '. Posso te ajudar a finalizar sua compra?')}
                            target="_blank"
