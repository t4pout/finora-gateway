    ...
    <>
      ...
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        .checkout-container { min-height: 100vh; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, sans-serif; }
        ...
        .payment-card { padding: 24px 20px; border: 3px solid #e5e7eb; border-radius: 16px; background: white; cursor: pointer; transition: all 0.3s; text-align: center; position: relative; min-height: 160px; display: flex; flex-direction: column; justify-content: center; }
